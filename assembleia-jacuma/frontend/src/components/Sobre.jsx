      ...
      <div className="container">
        <div className="bem-vindo-grid">
          ...
          <div className="bem-vindo-imagem">
            <img
              className="bem-vindo-foto"
              src="https://images.unsplash.com/photo-1602024242516-fbc9d4fda4b6?w=800&q=80"
              alt="Culto na Assembleia de Deus em Jacumã"
              loading="lazy"
            />
          ...
          <div>
            ...
            <h2 className="secao-titulo">
              Uma Igreja<br />de Propósito
            </h2>
            <div className="divisor-dourado" />

            <p className="secao-descricao">
              A Assembleia de Deus em Jacumã é uma comunidade de fé que há mais de três
              décadas vem impactando vidas no litoral sul da Paraíba. Nossa missão é simples:
              amar a Deus e ao próximo, proclamar o Evangelho e fazer discípulos.
            </p>
            <p className="secao-descricao">
              Somos uma igreja pentecostal, alicerçada nas Sagradas Escrituras, onde
              todos são bem-vindos para encontrar salvação, cura e restauração em Jesus Cristo.
            </p>
